...
func init() {
	register(
		...
		Config{
			...
			Volumes:         hfMountDefault,
			Runtime:         runtimeDefault,
			Description:     "ModelOpt NVFP4 Qwen3.6 27B text-only checkpoint for single-GPU Blackwell.",
			...
			Notes: []string{
				...
				"Disables speculative MTP decoding because Qwen3.6 hybrid GDN speculative decoding can trigger CUDA illegal-memory-access engine failures.",
