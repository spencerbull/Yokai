...
func init() {
	register(
		...
		Config{
			...
			Volumes:         hfMountDefault,
			Runtime:         runtimeDefault,
			Description:     "NVFP4 Blackwell deployment of Gemma 4 26B A4B MoE with image input, 256K context, and 30 active sequences.",
			Source:          "Hugging Face nvidia/Gemma-4-26B-A4B-NVFP4; vLLM Google/Gemma4 recipe",
